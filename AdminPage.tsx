    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center px-24 py-8">
                <h2 className="text-xl font-semibold mt-4 text-center">Produtos cadastrados</h2>
                
                <button onClick={handleNavigate} className="bg-blue-500 text-white px-4 py-2 rounded-md mt-4 mb-4 self-end">
