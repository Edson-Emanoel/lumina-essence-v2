    ...
    <div className="min-h-screen flex flex-col font-sans text-stone-800">
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-xs animate-fade-in-up flex flex-col justify-center items-center">
            <h2 className="text-lg font-bold mb-4 text-center">Digite a senha de administrador</h2>
            <input
              type="password"
              className="border border-stone-300 rounded-lg px-4 py-2 w-full mb-4 focus:outline-none focus:ring-2 focus:ring-brand-500"
              placeholder="Senha"
              value={passwordInput}
            ...
            <div className="flex gap-2 justify-center">
              <button
                ...
                onClick={() => validateAdminPassword(passwordInput)}
